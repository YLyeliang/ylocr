...
class FakeTextDataGenerator(object):
    ...
    def generate(
        ...
        Args:
            ...
            blur(int): 模糊半径/强度
            random_blur(bool):
            background_type(int): 0:gaussian noise 1:plain white 2: 晶体 3: 纯色 4:图片
            ...
            random_alpha(bool): Whether add 透明度
        ...
        if background_type == 3:  # 纯色背景
            ...
            pic = Image.open(
                image_dir[rnd.randint(0, len(image_dir) - 1)])  # built_in random include both borders
        ...
        if is_handwritten:
            ...
            # old type: image, mask, text
            # new type: image, text
            image, text = computer_text_generator.generate(
                text,
                font,
                t_color,
                size,
